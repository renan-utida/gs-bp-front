        ...
        <footer className="text-white w-full h-auto p-10 sm:px-20 sm:pt-20 bg-green-950">
            <div className='flex flex-col'>
                ...
                <div className='flex flex-col sm:flex-row'>
                    ...
                    <div className='flex flex-col mt-12 sm:w-1/2'>
                        <h3 className='text-[28px] lg:text-4xl text-green-300 mb-4 sm:mb-5 font-bold'>Follow Us</h3>
                        ...
                        <h3 className='text-[28px] lg:text-4xl max-sm:mt-12 sm:mt-7 text-green-300 mb-4 sm:mb-5 font-bold'>Contact Us</h3>
                        <ul className='flex flex-row gap-6 md:gap-8 lg:gap-10'>
                            <li>
