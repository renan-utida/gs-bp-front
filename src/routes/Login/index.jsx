...
const Login = () => {
    ...
    return(
        <main className="mt-20 min-h-screen flex justify-center items-start relative bg-login bg-cover bg-center sombra-login">
            ...
            <section className="relative bg-white/10 backdrop-blur-[10px] border-2 border-white/80 py-8 sm:py-6 xl:py-8 max-[400px]:px-4 px-6 lg:px-8 rounded-2xl my-12 md:my-14 xl:mt-16 xl:mb-20 mx-auto max-[400px]:w-64 md:min-w-[25rem] lg:min-w-[30rem] xl:min-w-[36rem]">
