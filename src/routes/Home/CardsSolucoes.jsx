...
const CardSolucoes = ({ handleRestrictedNavigation }) => {
    ...
    return(
        <section className="flex flex-col items-center max-w-full mx-20 max-sm:mx-8 max-[335px]:mx-4">
            <section className="flex flex-col md:flex-row  w-full h-auto px-7 py-7 border-4 border-black rounded-3xl mb-12 lg:mb-16 xl:mb-20 shadow-[0_0_100px_rgba(0,0,0,0.2)] hover:shadow-[0_0_50px_rgba(0,0,0,0.7)] hover:scale-[1.02] transition-all ease-in-out duration-500">
